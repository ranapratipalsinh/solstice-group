        ...
        <div>
                    ...
                    <button
                        ...
                        className={`rounded-full px-5 py-3 text-sm font-semibold transition-colors ${
                            activeFilter === 'all'
                                ...
                                : 'bg-solstice-50 text-solstice-700 hover:bg-solstice-100'
                        }`}
                    >
                        All
                    </button>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {filtered.map((project) => (
                    <article
                        key={project.slug}
                        className="overflow-hidden rounded-3xl border border-slate-200 bg-solstice-50 shadow-sm dark:border-slate-700/60"
                    >
