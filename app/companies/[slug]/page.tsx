        ...
        <div className="container py-16">
            <div className="rounded-[2rem] bg-white p-6 shadow-sm sm:p-10 dark:bg-slate-900">
                <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="rounded-3xl bg-solstice-50 p-8 shadow-sm dark:border dark:border-slate-700/60 dark:bg-slate-800 dark:shadow-none">
                ...
                <div className="mt-12 grid gap-8 lg:grid-cols-2">
                    <section className="rounded-3xl bg-slate-50 p-8 dark:border dark:border-slate-700/60 dark:bg-slate-800">
                        ...
                        <ul className="mt-5 space-y-3 text-slate-600 dark:text-slate-400">
                            {company.services.map((service) => (
                                <li key={service} className="rounded-3xl bg-white p-4 shadow-sm dark:border dark:border-slate-600/60 dark:bg-slate-700 dark:shadow-none">{service}</li>
                            ))}
                        </ul>
                    </section>
                    <section className="rounded-3xl bg-white p-8 shadow-sm dark:border dark:border-slate-700/60 dark:bg-slate-800 dark:shadow-none">
