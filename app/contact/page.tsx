            ...
            <section className="bg-white py-16 dark:bg-solstice-900 sm:py-20">
                <div className="container grid gap-10 lg:grid-cols-[0.9fr_0.8fr]">
                    <ScrollReveal>
                        <div className="space-y-6">
                            <div className="rounded-3xl bg-solstice-50 p-6">
                                ...
                                <p className="mt-2 text-slate-700">{settings.officeAddress}</p>
                            </div>
                            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700/60 dark:bg-solstice-800 dark:shadow-none">
                    ...
                    <ScrollReveal delayMs={200}>
                        <div className="h-full rounded-[2rem] border border-slate-200 bg-solstice-50 p-6 shadow-sm dark:border-slate-700/60 sm:p-10">
                            <h2 className="font-display text-2xl font-semibold text-slate-950">{siteCopy.contactFormHeading}</h2>
                            <p className="mt-4 leading-7 text-slate-600">{siteCopy.contactFormDescription}</p>
