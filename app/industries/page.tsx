                    ...
                    {industries.map((industry, index) => {
                        ...
                        return (
                            <ScrollReveal key={industry.title} delayMs={((index % 3) + 1) * 200}>
                                <div className="h-full rounded-3xl border border-slate-200 bg-solstice-50 p-7 dark:border-slate-700/60">
                                    ...
                                    {company && (
                                        <Link
                                            ...
                                            className="mt-4 inline-flex items-center text-sm font-semibold text-solstice-700 hover:text-solstice-800"
                                        >
                                            Led by {company.name} →
                                        </Link>
                                    )}
