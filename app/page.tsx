    ...
    return (
        <div>
                                ...
                                <div
                                    className={`rounded-3xl p-6 text-center ${
                                        region.isHeadquarters
                                            ? 'bg-solstice-600 text-white'
                                            : 'border border-solstice-100 bg-solstice-50 text-slate-800'
                                    }`}
                                >
            ...
            <section className="bg-white py-14 sm:py-16">
                <div className="container">
                    <ScrollReveal>
                        <div className="rounded-[2rem] bg-solstice-600 px-8 py-14 text-center text-white sm:px-16 sm:py-16">
                            <h2 className="font-display text-2xl font-semibold sm:text-3xl">Start Your Business Journey With Us</h2>
                            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
                                <Link
                                    href="/contact"
                                    className="w-full rounded-full bg-white px-8 py-3 text-sm font-semibold text-solstice-700 hover:bg-solstice-50 sm:w-auto"
                                >
                                    Get Consultation
                                </Link>
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex w-full items-center justify-center gap-2 rounded-full border border-white/50 px-8 py-3 text-sm font-semibold text-white hover:bg-white/10 sm:w-auto"
                                >
