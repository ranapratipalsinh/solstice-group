...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable content for the About page and founder message';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'News / Blog articles';
...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Solstice Group subsidiary companies';
    displayName: 'Company';
...
export interface ApiCsrPageCsrPage extends Struct.SingleTypeSchema {
  collectionName: 'csr_page';
  info: {
    description: 'Corporate social responsibility page content';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Upcoming and past events / exhibitions';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Photo / video gallery entries';
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable content for the homepage hero and stats';
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industries the group serves';
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Partners and clients';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiRegionRegion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Countries / regions where the group operates';
    displayName: 'Region';
    pluralName: 'regions';
    singularName: 'region';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings: contact info, logo, social links';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Leadership and founder profiles';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client and partner testimonials';
